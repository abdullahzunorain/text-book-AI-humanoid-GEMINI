...
from vector_store import get_qdrant_client, init_qdrant_collection, TEXTBOOK_COLLECTION
from crud_vectors import upsert_textbook_segments_batch, get_collection_stats
